...
class SearchDocument extends Component {
  ...
  render() {
    ...
    const mappedResults = this.props.result.map((document, index) =>
      ...
      <
      Button className = "teal darken-2"
      type = "submit" >
      UPDATE < /Button> < /
      form > <
      /Modal> <
    ...
    return ( <
      div className = "row" >
      <
      h5 className = "green-text" > Search
      for all documents Here.. < /h5> <
      div >
      <
      Input name = "search"
      id = "search"
